...
public class GoalMesg extends Mesg {
   ...
   static {
      ...
      goalMesg.addField(new Field("message_index", 254, 132, 1, 0, "", false));
      
      goalMesg.addField(new Field("sport", 0, 0, 1, 0, "", false));
      
      goalMesg.addField(new Field("sub_sport", 1, 0, 1, 0, "", false));
      
      goalMesg.addField(new Field("start_date", 2, 134, 1, 0, "", false));
      
      goalMesg.addField(new Field("end_date", 3, 134, 1, 0, "", false));
      
      goalMesg.addField(new Field("type", 4, 0, 1, 0, "", false));
      
      goalMesg.addField(new Field("value", 5, 134, 1, 0, "", false));
      
      goalMesg.addField(new Field("repeat", 6, 0, 1, 0, "", false));
      
      goalMesg.addField(new Field("target_value", 7, 134, 1, 0, "", false));
      
      goalMesg.addField(new Field("recurrence", 8, 0, 1, 0, "", false));
      
      goalMesg.addField(new Field("recurrence_value", 9, 132, 1, 0, "", false));
      
      goalMesg.addField(new Field("enabled", 10, 0, 1, 0, "", false));
