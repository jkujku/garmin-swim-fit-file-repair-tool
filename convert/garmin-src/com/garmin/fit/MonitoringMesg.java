...
public class MonitoringMesg extends Mesg {
   ...
   static {
      ...
      field_index++;
      monitoringMesg.addField(new Field("ascent", 31, 134, 1000, 0, "m", false));
      field_index++;
      monitoringMesg.addField(new Field("descent", 32, 134, 1000, 0, "m", false));
      field_index++;
      monitoringMesg.addField(new Field("moderate_activity_minutes", 33, 132, 1, 0, "minutes", false));
      field_index++;
      monitoringMesg.addField(new Field("vigorous_activity_minutes", 34, 132, 1, 0, "minutes", false));
      field_index++;
   }
