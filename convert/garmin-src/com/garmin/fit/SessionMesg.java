...
public class SessionMesg extends Mesg implements MesgWithEvent {
   ...
   static {
      ...
      field_index++;
      sessionMesg.addField(new Field("hi18n33", 33, 132, 1, 0, "", false));
      field_index++;
      sessionMesg.addField(new Field("hi18n78", 78, 134, 1, 0, "", false));
      field_index++;
      sessionMesg.addField(new Field("hi18n79", 79, 132, 1, 0, "", false));
      field_index++;
      sessionMesg.addField(new Field("hi18n80", 80, 132, 1, 0, "", false));
      field_index++;
   }
