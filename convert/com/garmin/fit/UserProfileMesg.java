...
public class UserProfileMesg extends Mesg {
   ...
   static {
      ...
      userProfileMesg.addField(new Field("message_index", 254, 132, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("friendly_name", 0, 7, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("gender", 1, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("age", 2, 2, 1, 0, "years", false));
      
      userProfileMesg.addField(new Field("height", 3, 2, 100, 0, "m", false));
      
      userProfileMesg.addField(new Field("weight", 4, 132, 10, 0, "kg", false));
      
      userProfileMesg.addField(new Field("language", 5, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("elev_setting", 6, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("weight_setting", 7, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("resting_heart_rate", 8, 2, 1, 0, "bpm", false));
      
      userProfileMesg.addField(new Field("default_max_running_heart_rate", 9, 2, 1, 0, "bpm", false));
      
      userProfileMesg.addField(new Field("default_max_biking_heart_rate", 10, 2, 1, 0, "bpm", false));
      
      userProfileMesg.addField(new Field("default_max_heart_rate", 11, 2, 1, 0, "bpm", false));
      
      userProfileMesg.addField(new Field("hr_setting", 12, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("speed_setting", 13, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("dist_setting", 14, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("power_setting", 16, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("activity_class", 17, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("position_setting", 18, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("temperature_setting", 21, 0, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("local_id", 22, 132, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("global_id", 23, 13, 1, 0, "", false));
      
      userProfileMesg.addField(new Field("height_setting", 30, 0, 1, 0, "", false));
