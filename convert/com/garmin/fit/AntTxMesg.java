...
public class AntTxMesg extends Mesg {
   ...
   static {int field_index = 0;
      ...
      antTxMesg.addField(new Field("timestamp", 253, 134, 1, 0, "s", false));
      field_index++;
      antTxMesg.addField(new Field("fractional_timestamp", 0, 132, 32768, 0, "s", false));
      field_index++;
      antTxMesg.addField(new Field("mesg_id", 1, 13, 1, 0, "", false));
      field_index++;
      antTxMesg.addField(new Field("mesg_data", 2, 13, 1, 0, "", false));
      ...
      antTxMesg.fields.get(field_index).components.add(new FieldComponent(4, false, 8, 1, 0)); // data
      field_index++;
      antTxMesg.addField(new Field("channel_number", 3, 2, 1, 0, "", false));
      field_index++;
      antTxMesg.addField(new Field("data", 4, 13, 1, 0, "", false));
      field_index++;
   }
