...
public class LapMesg extends Mesg implements MesgWithEvent {
   ...
   static {
      ...
      field_index++;
      lapMesg.addField(new Field("hi19n70", 70, 134, 2, 0, "", false));
      field_index++;
      lapMesg.addField(new Field("hi19n72", 72, 132, 2, 0, "", false));
      field_index++;
      lapMesg.addField(new Field("hi19n73", 73, 132, 2, 0, "", false));
      field_index++;
      lapMesg.addField(new Field("hi19n64", 64, 2, 2, 0, "", false));
      field_index++;
   }
