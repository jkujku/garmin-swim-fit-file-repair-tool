...
public class Factory {
   static public Mesg createMesg(Mesg mesg) {
      switch (mesg.getNum()) {       
         ...
         case MesgNum.HI24:
             return new HI24Mesg(mesg);
         case MesgNum.HI36:
             return new HI36Mesg(mesg);
         default:
            System.out.println("found unknown message: " + mesg.getNum());
            break;
      }
   ...
   static public Mesg createMesg(int mesgNum) {
      for (int i = 0; i < mesgs.length; i++) {
         if (mesgs[i].num == mesgNum){
             //System.out.println(mesgs[i].num);
             return new Mesg(mesgs[i]);
         }
            
      }
      System.out.println(mesgNum);
   ...
   private static final Mesg mesgs[] = new Mesg[128];
   ...
   static {
      ...
      mesg_index++;
      mesgs[mesg_index] = HI24Mesg.hi24Mesg;
      mesg_index++;
      mesgs[mesg_index] = HI36Mesg.hi36Mesg;
      mesg_index++;
   }
}
